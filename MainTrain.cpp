...
void clientSide2(int port,string outputFile)throw (const char*){
	...
	ofstream out(outputFile);
	ifstream in("/home/shir/Documents/advenced_programing/ex6/input.txt");
	string input="";
	while(input!="6"){
		readMenue(out,serverFD);
		getline(in,input);			
...
int main(){
	...
	string outputFile1="/home/shir/Documents/advenced_programing/ex6/output_menu";
	string outputFile2="/home/shir/Documents/advenced_programing/ex6/output";
	int x=rand() % 1000;
